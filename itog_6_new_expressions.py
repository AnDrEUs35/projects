...
def  move_func(s, t):
    ...
    dxdt1 = vx1
    dvxdt1 = -rg * c**2 * x1 / 2 * (x1**2 + y1**2)**1.5 + l**2 * x1 / (x1**2 + y1**2)**5/2 - 3 * l**2 * rg * x1 / (x1**2 + y1**2)**7/2
    dydt1 = vy1
    dvydt1 = -rg * c**2 * y1 / 2 * (x1**2 + y1**2)**1.5 + l**2 * y1 / (x1**2 + y1**2)**5/2 - 3 * l**2 * rg * y1 / (x1**2 + y1**2)**7/2
...
c = 300000000
rg = 2 * G * m / c**2
#l = (x0e * vy0e - y0e * vx0e) / np.sqrt(x0e**2 + y0e**2)
